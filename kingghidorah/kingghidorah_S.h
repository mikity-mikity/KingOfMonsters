...
namespace KingOfMonsters {
	...
	public:
		...
		const int ___ll[4]{ 0,3,6,9 };
	public:
		double x, y, z, Z, _Z, phi, eta, xi;/// , chi;
		double dv, _dv;
	public:
	...
	public:
		...
		{
			double length = 0, gamma = 0, _t1 = v1, _t2 = v2, t1 = 0, t2 = 0, n1 = 0, n2 = 0, T1 = 0, T2 = 0, N1 = 0, N2 = 0;
		...
		double guide2(double v1, double v2, bool accurate)
		{
			...
			double k21 = k12;
			val = k11 * v1 * v1 * _ref->get__gij(0, 1) + k11 * v1 * v2 * _ref->get__gij(1, 1) + k12 * v2 * v1 * _ref->get__gij(0, 1) + k12 * v2 * v2 * _ref->get__gij(1, 1);
			return val / _ref->_refDv;
		}
		void guide2_z(double* ptr, double v1, double v2, bool accurate)
		{
			...
			for (int s = 0; s < _ref->_nNode; s++)
			{
				...
				double _k21 = _k12;
				val = _k11 * v1 * v1 * _ref->get__gij(0, 1) + _k11 * v1 * v2 * _ref->get__gij(1, 1) + _k12 * v2 * v1 * _ref->get__gij(0, 1) + _k12 * v2 * v2 * _ref->get__gij(1, 1);
		...
		double guide3(double v1, double v2, bool accurate)
		{
			...
			double S21 = S12;
			val = S11 * S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
			val += S11 * S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
			val += S11 * S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
			val += S11 * S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

			val += S12 * S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
			val += S12 * S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
			val += S12 * S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
			val += S12 * S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

			val += S11 * S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
			val += S21 * S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
			val += S21 * S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
			val += S21 * S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

			val += S22 * S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
			val += S22 * S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
			val += S22 * S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
			val += S22 * S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);
		...
		void guide3_z(double* ptr, double v1, double v2, bool accurate)
		{
			...
			for (int s = 0; s < _ref->_nNode; s++)
			{
				...
				double S21 = S12;
				val = _S11 * S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
				val += _S11 * S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
				val += _S11 * S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
				val += _S11 * S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

				val += _S12 * S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
				val += _S12 * S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
				val += _S12 * S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
				val += _S12 * S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

				val += _S11 * S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
				val += _S21 * S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
				val += _S21 * S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
				val += _S21 * S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

				val += _S22 * S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
				val += _S22 * S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
				val += _S22 * S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
				val += _S22 * S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

				val += S11 * _S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
				val += S11 * _S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
				val += S11 * _S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
				val += S11 * _S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

				val += S12 * _S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
				val += S12 * _S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
				val += S12 * _S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
				val += S12 * _S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

				val += S11 * _S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
				val += S21 * _S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
				val += S21 * _S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
				val += S21 * _S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);

				val += S22 * _S11 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 0);
				val += S22 * _S12 * _ref->get__Gij(0, 0) * _ref->get__Gij(0, 1);
				val += S22 * _S21 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 0);
				val += S22 * _S22 * _ref->get__Gij(0, 1) * _ref->get__Gij(0, 1);
		...
		void guide_supported_xi(double* ptr, double v1, double v2, bool accurate)
		{
			...
			for (int s = 0; s < _ref->_nNode; s++)
			{
				...
				//scale = 1;
				val = scale * (e11 * v1 * v1 + e12 * v1 * v2 + e12 * v2 * v1 + e22 * v2 * v2);
				val += -tr2 / tr / tr * (_e11 * v1 * v1 + _e12 * v1 * v2 + _e12 * v2 * v1 + _e22 * v2 * v2) * (e11 * _ref->get__Gij(0, 0) + 2 * e12 * _ref->get__Gij(0, 1) + e22 * _ref->get__Gij(1, 1));
		...
		void guide_supported_eta(double* ptr, double v1, double v2, bool accurate)
		{
			double val = 0;
		...
		double guide_free(double v1, double v2, bool accurate)
		{
			double val = 0;
		...
		void guide_free_xi(double* ptr, double v1, double v2, bool accurate)
		{
			double val = 0;
			...
			//	scale = 1;
				...
				val = scale * (e11 * v1 * v1 + e12 * v1 * v2 + e12 * v2 * v1 + e22 * v2 * v2);
				val += -tr2 / tr / tr * (_e11 * v1 * v1 + _e12 * v1 * v2 + _e12 * v2 * v1 + _e22 * v2 * v2) * (e11 + e22) / (_ref->get__gij(0, 0) + _ref->get__gij(1, 1)); 
				val -= scale * (k11 * v1 * v1 + k12 * v1 * v2 + k12 * v2 * v1 + k22 * v2 * v2)/det;
				val -= -tr2 / tr / tr * (_k11 * v1 * v1 + _k12 * v1 * v2 + _k12 * v2 * v1 + _k22 * v2 * v2) * (e11 + e22) / (_ref->get__gij(0, 0) + _ref->get__gij(1, 1))/det; 
		...
		void guide_free_z(double* ptr, double v1, double v2, bool accurate)
		{
			double val = 0;
		...
		void guide_free_eta(double* ptr, double v1, double v2, bool accurate)
		{
			double val = 0;
		...
		double mix(double v1, double v2, double w1, double w2, bool accurate)
		{
			...
			E12 = -e12;
			E21 = E12;
			//E11 = _ref->get__gij(1, 1);
			//E12 = -_ref->get__gij(0, 1);
			//E12 = -_ref->get__gij(0, 1);
			//E22 = _ref->get__gij(0, 0);
			...
			val = 1. / tr / TRACE * (s11 * E11 * S12 + s11 * E12 * S22 + s12 * E21 * S12 + s12 * E22 * S22)*sc / _ref->_refDv;;// / sc;
			val -= 1. / tr / TRACE * (s21 * E11 * S11 + s21 * E12 * S21 + s22 * E21 * S11 + s22 * E22 * S21) * sc / _ref->_refDv;;// / sc;
		...
		void mix_Z(double* ptr, double v1, double v2, double w1, double w2, bool accurate)
		{
			...
			for (int s = 0; s < _ref->_nNode; s++)
			{
				...
				//TRACE = 1;
				val = 1. / tr / TRACE * (s11_phi * E11 * _S12 + s11_phi * E12 * _S22 + s12_phi * E21 * _S12 + s12_phi * E22 * _S22) * sc / _ref->_refDv;// / sc;
				val -= 1. / tr / TRACE * (s21_phi * E11 * _S11 + s21_phi * E12 * _S21 + s22_phi * E21 * _S11 + s22_phi * E22 * _S21) * sc / _ref->_refDv;// / sc;
		...
		void mix_xi(double* ptr, double v1, double v2, double w1, double w2, bool accurate)
		{
			...
			for (int s = 0; s < _ref->_nNode; s++)
			{
				...
				val += -1. / tr / tr /TRACE* (s11 * E11 * S12 + s11 * E12 * S22 + s12 * E21 * S12 + s12 * E22 * S22) * dtr / _ref->_refDv;
				val -= -1. / tr / tr /TRACE* (s21 * E11 * S11 + s21 * E12 * S21 + s22 * E21 * S11 + s22 * E22 * S21) * dtr / _ref->_refDv;
		...
		void mix_eta( double *ptr,double v1, double v2, double w1, double w2, bool accurate)
		{
			...
			//double TRACE =(E11+E22)/(_r->get__Gij2(0, 0) + _ref->get__gij(1, 1));
			double TRACE = 1;
			for(int s = 0; s < _ref->_nNode; s++)
			{
				double val;
				...
				val += -1. / tr / tr / TRACE * (s11 * E11 * S12 + s11 * E12 * S22 + s12 * E21 * S12 + s12 * E22 * S22) * dtr / _ref->_refDv;// / sc;
				val -= -1. / tr / tr / TRACE * (s21 * E11 * S11 + s21 * E12 * S21 + s22 * E21 * S11 + s22 * E22 * S21) * dtr / _ref->_refDv;// / sc;
		...
		double setEij_A(double v1, double v2, double w1, double w2, bool accurate)
		{
			...
			val = scale * ((e11 * v1 * v1) + (e12 * v1 * v2) + (e21 * v2 * v1) + (e22 * v2 * v2)) * w1;
 		    val-= scale * w2 * ((k11 * v1 * v1) + (k12 * v1 * v2) + (k21 * v2 * v1) + (k22 * v2 * v2))/det;
			return val;
		}
		void setEij_A_xi(double* ptr, double v1, double v2, double w1, double w2, bool accurate)
		{
			...
			for (int s = 0; s < _ref->_nNode; s++)
			{
				...
				double k21 = k12;
				val = scale * ((e11 * v1 * v1) + (e12 * v1 * v2) + (e21 * v2 * v1) + (e22 * v2 * v2)) * w1;
				val += -w2 * scale * ((k11 * v1 * v1) + (k12 * v1 * v2) + (k21 * v2 * v1) + (k22 * v2 * v2))/det;
				val += -w1 * tr2 / tr / tr * ((_e11 * v1 * v1) + (_e12 * v1 * v2) + (_e21 * v2 * v1) + (_e22 * v2 * v2)) * (e11 + e22);
				val += w2 *tr2 / tr / tr * ((_k11 * v1 * v1) + (_k12 * v1 * v2) + (_k21 * v2 * v1) + (_k22 * v2 * v2)) * (e11 + e22)/det;
		...
		void  setEij_A_Z(double* ptr, double v1, double v2, double w1, double w2, bool accurate)
		{
			...
			for (int s = 0; s < _ref->_nNode; s++)
			{
				...
				double k21 = k12;
				double ddet = g11 * this->get_gij2(1, 1) + this->get_gij2(0, 0) * g22 - 2 * this->get_gij2(0, 1) * g12;
				val = -w2 * scale * ((k11 * v1 * v1) + (k12 * v1 * v2) + (k21 * v2 * v1) + (k22 * v2 * v2)) / det;
				val += w2 * scale * ((_k11 * v1 * v1) + (_k12 * v1 * v2) + (_k21 * v2 * v1) + (_k22 * v2 * v2)) / det/det*ddet;
				*ptr1 = val;
				ptr1++;
			}
		}
	...
	public:
		...
		void  curvature_Z(mySparse^ mat, int ii, myIntArray^ index, double sc, double c1, double v1, double v2, bool accurate)
		{
		...
		double guide_free(double v1, double v2, bool accurate)
		{
			return __mem->guide_free(v1, v2, accurate);
		}
		...
		void guide_z_free(mySparse^ mat, int ii, myIntArray^ index, double sc, double c1, double v1, double v2, bool accurate)
		{
			__mem->guide_free_z(__mem->__grad, v1, v2, accurate);
			mat->dat->addrow(ii, index->_arr, __mem->__grad, 0, sc, __mem->_nNode, true, c1);
		}
