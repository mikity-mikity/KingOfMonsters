...
namespace KingOfMonsters {
	...
	public:
		...
		std::vector<Eigen::SparseMatrix<double, Eigen::ColMajor, int>> _mat;
	...
	public:
		...
		//void join();
		std::string info();
		void permute(Eigen::PermutationMatrix<Eigen::Dynamic, Eigen::Dynamic, int>& perm);
		void shrink(int64_t M);
		void _permute(Eigen::PermutationMatrix<Eigen::Dynamic, Eigen::Dynamic, int>& perm, bool sparse, bool dense);
		void _permuteCols(Eigen::PermutationMatrix<Eigen::Dynamic, Eigen::Dynamic, int>& perm, bool sparse, bool dense);
		void _shrink(int64_t M, bool sparse, bool dense);
		void _shrinkCols(int64_t M, bool sparse, bool dense);
		void _permute(Eigen::PermutationMatrix<Eigen::Dynamic, Eigen::Dynamic, int>& perm, Eigen::PermutationMatrix<Eigen::Dynamic, Eigen::Dynamic, int>& perm2);
		...
		void addrow(int64_t ii, int* ptr, double* data, double sc, int64_t N);
		void addrow(int64_t ii, int* ptr, double* data, double sc, int64_t N, double _coeff);
		void addrow(int64_t ii, int* ptr, double* data, int64_t shift, double sc, int64_t N, bool add, double __coeff);
		...
		std::string _solve0_lu_cpu(Eigen::VectorXd* rhs, Eigen::VectorXd* ret, int64_t ordering);
		std::string _solve0_chol_cpu(Eigen::VectorXd* rhs, Eigen::VectorXd* ret, int64_t ordering);
